...
def main():
    ...
    map.intersect.append(Node("Bali", 130, 20, canvas))
    ...
    map.road.append(Road(map.intersect[5], map.intersect[6], 1500, 2, canvas))
    map.road.append(Road(map.intersect[6], map.intersect[5], 1500, 2, canvas))
    map.road.append(Road(map.intersect[5], map.intersect[4], 1000, 5, canvas))
    ...
    map.road.append(Road(map.intersect[2], map.intersect[1], 1500, 2, canvas))

    map.road.append(Road(map.intersect[2], map.intersect[7], 1500, 5, canvas))
    map.road.append(Road(map.intersect[3], map.intersect[8], 600, 50000, canvas))              ############
    map.road.append(Road(map.intersect[4], map.intersect[9], 600, 50000, canvas))              ############
    map.road.append(Road(map.intersect[4], map.intersect[10], 1500, 5, canvas))
    map.road.append(Road(map.intersect[5], map.intersect[11], 1500, 5, canvas))
    map.road.append(Road(map.intersect[2], map.intersect[9], 600, 5, canvas))              ############

    map.road.append(Road(map.intersect[7], map.intersect[8], 1000, 5, canvas))
    map.road.append(Road(map.intersect[8], map.intersect[9], 1000, 5, canvas))
    map.road.append(Road(map.intersect[9], map.intersect[10], 1000, 5, canvas))
    map.road.append(Road(map.intersect[10], map.intersect[11], 1000, 5, canvas))
    map.road.append(Road(map.intersect[11], map.intersect[10], 1000, 5, canvas))
    map.road.append(Road(map.intersect[10], map.intersect[9], 1000, 5, canvas))
    map.road.append(Road(map.intersect[9], map.intersect[8], 1000, 5, canvas))
    map.road.append(Road(map.intersect[8], map.intersect[7], 1000, 5, canvas))

    map.road.append(Road(map.intersect[7], map.intersect[12], 1500, 2, canvas))
    map.road.append(Road(map.intersect[10], map.intersect[13], 1500, 2, canvas))
    map.road.append(Road(map.intersect[11], map.intersect[14], 1500, 2, canvas))

    #reverse
    map.road.append(Road(map.intersect[12], map.intersect[7], 1500, 2, canvas))
    map.road.append(Road(map.intersect[13], map.intersect[10], 1500, 2, canvas))
    map.road.append(Road(map.intersect[14], map.intersect[11], 1500, 2, canvas))

    map.road.append(Road(map.intersect[7], map.intersect[2], 1500, 5, canvas))
    map.road.append(Road(map.intersect[8], map.intersect[3], 600, 50000, canvas))              ############
    map.road.append(Road(map.intersect[9], map.intersect[4], 600, 50000, canvas))              ############
    map.road.append(Road(map.intersect[10], map.intersect[4], 1500, 5, canvas))
    map.road.append(Road(map.intersect[11], map.intersect[5], 1500, 5, canvas))
    map.road.append(Road(map.intersect[9], map.intersect[2], 600, 50000, canvas))              ############

    map.road.append(Road(map.intersect[3], map.intersect[0], 1500, 2, canvas))
    ...
    route_6to12.extend([road_list4, road_list5, road_list6, road_list7, road_list8])
    ...
    route_12to1.append(road_list26)
    ...
    route_12to6.extend([road_list41, road_list42, road_list43, road_list44, road_list45])
    ...
    route_14to6.append(road_list48)
    ...
    """
    vehicle_list = []
    for times in range(0, 720, 2):
        
        vehicle_list.append(Vehicle(map.intersect[12], times, route_choose(route_1to12), random.randint(1, 50)))
        vehicle_list.append(Vehicle(map.intersect[12], times, route_choose(route_0to12), random.randint(1, 50)))
        vehicle_list.append(Vehicle(map.intersect[12], times, route_choose(route_6to12), random.randint(1, 50)))
        vehicle_list.append(Vehicle(map.intersect[13], times, route_choose(route_1to13), random.randint(1, 50)))
        vehicle_list.append(Vehicle(map.intersect[13], times, route_choose(route_0to13), random.randint(1, 50)))
        vehicle_list.append(Vehicle(map.intersect[13], times, route_choose(route_6to13), random.randint(1, 50)))
        vehicle_list.append(Vehicle(map.intersect[14], times, route_choose(route_1to14), random.randint(1, 50)))
        vehicle_list.append(Vehicle(map.intersect[14], times, route_choose(route_0to14), random.randint(1, 50)))
        vehicle_list.append(Vehicle(map.intersect[14], times, route_choose(route_6to14), random.randint(1, 50)))
        vehicle_list.append(Vehicle(map.intersect[6], times, route_choose(route_1to6), random.randint(1, 50)))
        vehicle_list.append(Vehicle(map.intersect[1], times, route_choose(route_6to1), random.randint(1, 50)))
        
        vehicle_list.append(Vehicle(map.intersect[1], times, route_choose(route_12to1), random.randint(1, 50)))
        vehicle_list.append(Vehicle(map.intersect[1], times, route_choose(route_13to1), random.randint(1, 50)))
        vehicle_list.append(Vehicle(map.intersect[1], times, route_choose(route_14to1), random.randint(1, 50)))
        vehicle_list.append(Vehicle(map.intersect[0], times, route_choose(route_12to0), random.randint(1, 50)))
        vehicle_list.append(Vehicle(map.intersect[0], times, route_choose(route_13to0), random.randint(1, 50)))
        vehicle_list.append(Vehicle(map.intersect[0], times, route_choose(route_14to0), random.randint(1, 50)))
        vehicle_list.append(Vehicle(map.intersect[6], times, route_choose(route_12to6), random.randint(1, 50)))
        vehicle_list.append(Vehicle(map.intersect[6], times, route_choose(route_13to6), random.randint(1, 50)))
        vehicle_list.append(Vehicle(map.intersect[6], times, route_choose(route_14to6), random.randint(1, 50)))
